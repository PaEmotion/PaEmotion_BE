...
class User(Base):
    ...
    totalBudgets = relationship("TotalBudget", back_populates="user")
    challengeParticipants = relationship("ChallengeParticipant", back_populates="user", cascade="all, delete-orphan")